...
public class Constants {
    ...
    public static final String DIR_BASE = "CYY";
    ...
    public static final String TEL = "15093427942";
    public static final String ACTION_VISIBLE = "action_visible";
    public static final String URL_WAP_FAQ = "http://xmy.dz.palmapp.cn/wap/faq.aspx";//常用问题
}
