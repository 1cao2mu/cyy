    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mPointMap == null || mPointMap.size() == 0) {
            ...
            for (int i = 0; i < mYAxis.length; i++) {
                ...
                canvas.drawLine(0, i * yInterval+mYAxisFontSize, mWidth,  i * yInterval+mYAxisFontSize, axisPaint);
            ...
            for (int i = 0; i < mXAxis.length; i++) {
                ...
                canvas.drawLine(i * xInterval+ xItemX + xOffset+mYAxisFontSize/2, 0, i * xInterval+ xItemX + xOffset+mYAxisFontSize/2, mHeight, axisPaint);
