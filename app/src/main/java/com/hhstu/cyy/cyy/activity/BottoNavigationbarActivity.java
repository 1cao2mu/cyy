...
public class BottoNavigationbarActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, BottomNavigationBar.OnTabSelectedListener {
    ...
    private void refresh() {
        ...
        numberBadgeItem = new BadgeItem().setBorderColor(R.color.text_red)
                .setHideOnSelect(autoHide.isChecked()).setGravity(Gravity.TOP|Gravity.RIGHT);
