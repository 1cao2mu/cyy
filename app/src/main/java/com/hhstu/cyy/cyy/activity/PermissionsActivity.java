...
import com.hhstu.cyy.cyy.utils.ContactsUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermissionsManager.getInstance().requestAllManifestPermissionsIfNecessary(this, new PermissionsResultAction() {
            ...
            public void onGranted() {
                Toast.makeText(getContext(), R.string.message_granted, Toast.LENGTH_SHORT).show();
                ...
                PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(this,
                        new String[]{Manifest.permission.READ_CONTACTS}, new PermissionsResultAction() {
                            ...
                            public void onGranted() {
                                ...
                                ContactsUtils.readPhoneContacts(getContext());
                            }
