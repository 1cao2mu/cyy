...
public class SpanActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tv_title)).setText("TextView的Span");
...
//        Spanned.SPAN_INCLUSIVE_INCLUSIVE —— [a,b]
        ...
        //对英文字体有效,对中文字体无效
        msp.setSpan(new RelativeSizeSpan(3.0f), 0, 4, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        //放大字体观察
        msp.setSpan(new TypefaceSpan("monospace"), 0, 2, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        msp.setSpan(new TypefaceSpan("serif"), 2, 4, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//        msp.setSpan(new TypefaceSpan("sans-serif"), 4, 6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        try {
            XmlResourceParser xppcolor = getResources().getXml(R.xml.linkcolor);
