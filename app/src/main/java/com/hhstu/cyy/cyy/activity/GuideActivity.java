        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        tv_go.setVisibility(View.GONE);
                        iv_dot1.setImageResource(R.mipmap.icon_dot_blue);
                        iv_dot2.setImageResource(R.mipmap.icon_dot_normal_blue);
                        iv_dot3.setImageResource(R.mipmap.icon_dot_normal_blue);
                        break;
                    case 1:
                        tv_go.setVisibility(View.GONE);
                        iv_dot1.setImageResource(R.mipmap.icon_dot_normal_blue);
                        iv_dot2.setImageResource(R.mipmap.icon_dot_blue);
                        iv_dot3.setImageResource(R.mipmap.icon_dot_normal_blue);
                        break;
                    case 2:
                        tv_go.setVisibility(View.GONE);
                        iv_dot1.setImageResource(R.mipmap.icon_dot_normal_blue);
                        iv_dot2.setImageResource(R.mipmap.icon_dot_normal_blue);
                        iv_dot3.setImageResource(R.mipmap.icon_dot_blue);
